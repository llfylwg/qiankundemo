...
<div>
  <div>
    <zz-form :formOptions="formOptions" @submitHandler='submitHandler'></zz-form>
  </div>
  <div>
    <el-table
...
<script>
import zzForm from './zzForm'
import props from './formTableProps'
export default {
  name: 'zz-table',
  props,
  components: { zzForm },
  ...
  methods: {
    ...
    fetchData () {
      this.loading = true;
      let params = {};
      let { apiName, showPagination, pagination, form } = this; 
